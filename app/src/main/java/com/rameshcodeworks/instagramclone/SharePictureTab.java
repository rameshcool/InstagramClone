...
public class SharePictureTab extends Fragment implements View.OnClickListener {
    ...
    private ImageView imgViewSharePict;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgViewSharePict = view.findViewById(R.id.imgViewSharePict);
        edtTxtDescription = view.findViewById(R.id.edtTxtDescription);
        btnShareImage = view.findViewById(R.id.btnShareImage);

        imgViewSharePict.setOnClickListener(SharePictureTab.this);
            ...
            case R.id.btnShareImage:
                ...
                if (receivedImageBitmap != null) {
                    ...
                    if (edtTxtDescription.getText().toString().equals("")) {
                        ...
                        parseObject.put("image_des", edtTxtDescription.getText().toString());
        ...
        if (requestCode == 2000) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                try {
                    ...
                    imgViewSharePict.setImageBitmap(receivedImageBitmap);
